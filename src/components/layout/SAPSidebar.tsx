...
import {
  BarChart3, Box, Briefcase, Building2, ChevronDown, ChevronRight,
  ClipboardList, CreditCard, DollarSign, FileText, Gauge, Gift,
  LayoutGrid, Package, PackageCheck, PackageOpen,
  Settings, ShoppingCart, Truck, Users, Warehouse, X,
} from 'lucide-react'
...
export function SAPSidebar() {
  ...
  return (
    <aside
      ...
      style={{ width: sidebarCollapsed ? '0px' : '240px', borderRight: '1px solid #E2E8F0' }}
    >
